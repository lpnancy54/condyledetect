...
def find_condyle_region(
    ...
    # Étape 3: Affiner en favorisant les zones supérieures et postérieures
    # Les points du condyle doivent être plus hauts et plus postérieurs
    # que l'apophyse coronoïde.
