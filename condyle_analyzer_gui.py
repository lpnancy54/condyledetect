...
class CondyleDetector:
    ...
    def __init__(self, search_radius: float = 14.0):
    ...
    def find_condyle_region(self, vertices: np.ndarray, side: str, x_center: float) -> np.ndarray:
        ...
        # Étape 7: Filtrage vertical - ne garder que 9mm sous le sommet
        if len(condyle_points) > 10:
            z_max = condyle_points[:, 2].max()  # Sommet du condyle
            z_min_allowed = z_max - 9.0  # Maximum 9mm sous le sommet
...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.spin_radius.setValue(14.0)
